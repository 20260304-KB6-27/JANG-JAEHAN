...
public class Application2 {
    public static void main(String[] args) {
        ...
        System.out.println("tset.first() = " + tset.first()); // 가장 작은 요소 반환
        System.out.println("tset.last() = " + tset.last()); // 가장 큰 요소 반환
        ...
        System.out.println("tset.lower(25) = " + tset.lower(20)); // 25 미만인 요소 중 가장 큰 값
