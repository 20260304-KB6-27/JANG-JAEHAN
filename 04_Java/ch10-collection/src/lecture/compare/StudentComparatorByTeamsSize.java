...
public class StudentComparatorByTeamsSize implements Comparator<Student> {
    ...
    public StudentComparatorByTeamsSize(Map<String, Integer> teamCount) {
    ...
    public int compare(Student o1, Student o2) {
        ...
        // 2. 팀명 오름차순
        // 팀 이름 기준으로 compare의 결과값 (음수, 0, 양수)
