...
public class InvertImageExample {
    public static void main(String[] args) throws IOException {
        ...
        // 이미지 경로
        String source = "resources/pixel-art.png";
        String destination = "resources/pixel-art-invert.png"; // 색상 반전한 거 저장
        ...
        for (int y = 0; y < height; y++) {
            for (int x = 0; x < width; x++) {
                int argb = original.getRGB(x,y); // 해당 pixel의 색상을 32비트 정수(ARGB)로 변환
                // [AA|RR|GG|BB]
                int a = (argb >> 24) & 0xFF;
